(function ($) {
    ...
    $.fn.extend({
        ...
        getExcelHtml: function () {
            ...
            if (table.length == 1) {
                ...
                clone.find("td").removeClass("td-position-css").removeClass("td-chosen-css").removeClass(
                    "td-chosen-muli-css").removeAttr("contenteditable");
    ...
    function initTable(t, setting) {
        ...
        if (setting.type == 0) {
            ...
            clone.find("td").css("display", "").removeAttr("rowspan").removeAttr("colspan").html("").removeClass(
                "td-chosen-css");
    ...
    function getChosenList(table, begPosi, endPosi) {
        if (begPosi != undefined && endPosi != undefined) {
            var coll = [];
            for (var i = (begPosi.row > endPosi.row ? endPosi.row : begPosi.row); i <= (begPosi.row > endPosi.row ?
                begPosi.row : endPosi.row); i++) {
                var tr = table.find("tr:eq(" + i + ")");
                for (var j = (begPosi.col > endPosi.col ? endPosi.col : begPosi.col); j <= (begPosi.col > endPosi.col ?
                    begPosi.col : endPosi.col); j++) {
            ...
            while (true) {
                ...
                coll.each(function () {
                    ...
                    var r = p.row + ($(this).attr("rowspan") == undefined ? 0 : (Number($(this).attr(
                        "rowspan")) - 1));
                    var c = p.col + ($(this).attr("colspan") == undefined ? 0 : (Number($(this).attr(
                        "colspan")) - 1));
                ...
                coll.each(function () {
                    ...
                    if (!$(this).is(fir)) {
                        ...
                        if ($(this).attr("rowspan") != undefined && $(this).attr("colspan") != undefined) {
                            r = (p.row + (Number($(this).attr("rowspan")) - 1) - posi.row) > r ? (p.row + (
                                Number($(this).attr("rowspan")) - 1) - posi.row) : r;
                            c = (p.col + (Number($(this).attr("colspan")) - 1) - posi.col) > c ? (p.col + (
                                Number($(this).attr("colspan")) - 1) - posi.col) : c
                        }
                    }
                });
    ...
    function drugCell(table, t) {
        ...
        table.find("tr").each(function () {
            ...
            $("<div class='row-height-panel-item'></div>").attr("draggable", true).mousedown(function (e) {
                ...
                clearDurgEle(table, t)
            }).css("top", top - 4).css("width", firstTr.find("td")[0].offsetWidth).appendTo(
                rowHeightPanel)
        });
                    ...
                    if ($(this).attr("rowspan") && $(this).attr("colspan")) {
                        ...
                        if (ty == 4) {
                            ...
                            if (nextTr.length == 1 && Number($(this).attr("rowspan")) > 1) {
                                ...
                                nextTr.find("td:eq(" + ind + ")").attr("rowspan", spanNum($(this).attr(
                                    "rowspan"), -1)).attr("colspan", $(this).attr("colspan")).css(
                                    "display", "")
                            }
                        } else {
                    ...
                    if ($(this).attr("rowspan") && $(this).attr("colspan")) {
                        ...
                        if (ty == 5) {
                            ...
                            if (nextTd.length == 1 && Number($(this).attr("colspan")) > 1) {
                                nextTd.width($(this).width()).attr("rowspan", $(this).attr("rowspan")).attr(
                                    "colspan", spanNum($(this).attr("colspan"), -1)).css("display", "")
                            }
                        } else {
    ...
    function drawChosenArea(table, t) {
        ...
        if (coll.length > 0) {
            ...
            $("<div class='chosen-area-p'></div>").width(1).height(height + 1).css("margin-top", first[0].offsetTop -
                1).css("margin-left", first[0].offsetLeft - 1).insertBefore(table);
            $("<div class='chosen-area-p'></div>").width(width + 1).height(1).css("margin-top", first[0].offsetTop -
                1).css("margin-left", first[0].offsetLeft - 1).insertBefore(table);
            $("<div class='chosen-area-p'></div>").width(1).height(height - 4).css("margin-top", first[0].offsetTop -
                1).css("margin-left", first[0].offsetLeft + width - 1).insertBefore(table);
            $("<div class='chosen-area-p'></div>").width(width - 4).height(1).css("margin-top", first[0].offsetTop +
                height - 1).css("margin-left", first[0].offsetLeft - 1).insertBefore(table);
            $("<div class='chosen-area-p chosen-area-p-drug'></div>").mousedown(function () {
                ...
                if (coll.length == 2) {
                    ...
                    if (reg.test($.trim(coll.first().text())) && reg.test($.trim($(coll.get(1)).text()))) {
                        $(this).data("textNum", Number($.trim($(coll.get(1)).text())) - Number($.trim(coll.first()
                            .text())))
                    }
                }
            }).width(3).height(3).css("padding", "2px").css("margin-top", first[0].offsetTop + height - 3).css(
                "margin-left", first[0].offsetLeft + width - 3).insertBefore(table)
        }
    }
    ...
    function drawDrugArea(table) {
        ...
        table.find("tr").first().find("td:gt(0)").each(function () {
            ...
            // if (ind >= 26) {
            //     // char = String.fromCharCode(65 + (parseInt(ind / 26) - 1)) + String.fromCharCode(65 + ind %
            //     //     26);
            // }
            $(this).addClass("drug-ele-td").css("text-align", "center").html(titleData[ind]);
            ind++
        });
        ind = 0;
    ...
    function showRightPanel(table, t, e) {
        var coll = table.find(".td-chosen-css");
        closeRightPanel(t);
        var rightMousePanel = $("<div class='rightmouse-panel-div'></div>").css("left", e.clientX).css("top", e.clientY)
            .insertBefore(table);
        ...
        $("<div class='wb duiqifangsi'></div>").html(
            "<span class='excel-rightmomuse-icon-css'><i class='fa fa-th'></i></span><span class='excel-rightmomuse-text-css'>对齐方式</span><span class='excel-rightmomuse-icon-css excel-rightmomuse-icon-next-css'><i class='fa fa-caret-right'></i></span>"
        ).appendTo(leftPanel);
        $("<div class='wb hebingdanyuange'></div>").html(
            "<span class='excel-rightmomuse-icon-css'><i class='fa fa-columns'></i></span><span class='excel-rightmomuse-text-css'>合并单元格</span>"
        ).appendTo(leftPanel);
        $("<div class='wb shangchayihang'></div>").html(
            "<span class='excel-rightmomuse-icon-css'><i class='fa fa-angle-up'></i></span><span class='excel-rightmomuse-text-css'>上方插入一行</span>"
        ).appendTo(leftPanel);
        $("<div class='wb xiachayihang'></div>").html(
            "<span class='excel-rightmomuse-icon-css'><i class='fa fa-angle-down'></i></span><span class='excel-rightmomuse-text-css'>下方插入一行</span>"
        ).appendTo(leftPanel);
        $("<div class='wb zuochayilie'></div>").html(
            "<span class='excel-rightmomuse-icon-css'><i class='fa fa-angle-left'></i></span><span class='excel-rightmomuse-text-css'>左边插入一列</span>"
        ).appendTo(leftPanel);
        $("<div class='wb youchayilie'></div>").html(
            "<span class='excel-rightmomuse-icon-css'><i class='fa fa-angle-right'></i></span><span class='excel-rightmomuse-text-css'>右边插入一列</span>"
        ).appendTo(leftPanel);
        $("<div class='wb shanchuhang'></div>").html(
            "<span class='excel-rightmomuse-icon-css'><i class='fa fa-minus-square-o'></i></span><span class='excel-rightmomuse-text-css'>删除行</span>"
        ).appendTo(leftPanel);
        $("<div class='wb shanchulie'></div>").html(
            "<span class='excel-rightmomuse-icon-css'><i class='fa fa-minus-square'></i></span><span class='excel-rightmomuse-text-css'>删除列</span>"
        ).appendTo(leftPanel);
        $("<div class='wb chexiao' title='只能结构改变撤销'></div>").html(
            "<span class='excel-rightmomuse-icon-css'><i class='fa fa-reply-all'></i></span><span class='excel-rightmomuse-text-css'>撤销</span>"
        ).appendTo(leftPanel);
        $("<div class='wb juzhong'></div>").html(
            "<span class='excel-rightmomuse-icon-css'><i class='fa fa-align-justify'></i></span><span class='excel-rightmomuse-text-css'>居中</span>"
        ).appendTo(rightPanel);
        $("<div class='wb zuoduiqi'></div>").html(
            "<span class='excel-rightmomuse-icon-css'><i class='fa fa-align-left'></i></span><span class='excel-rightmomuse-text-css'>左对齐</span>"
        ).appendTo(rightPanel);
        $("<div class='wb youduiqi'></div>").html(
            "<span class='excel-rightmomuse-icon-css'><i class='fa fa-align-right'></i></span><span class='excel-rightmomuse-text-css'>右对齐</span>"
        ).appendTo(rightPanel);
        $("<div class='wb chuizhijuzhong'></div>").html(
            "<span class='excel-rightmomuse-icon-css'><i class='fa fa-navicon'></i></span><span class='excel-rightmomuse-text-css'>垂直居中</span>"
        ).appendTo(rightPanel);
        $("<div class='wb dingduanduiqi'></div>").html(
            "<span class='excel-rightmomuse-icon-css'><i class='fa fa-angle-double-up'></i></span><span class='excel-rightmomuse-text-css'>顶端对齐</span>"
        ).appendTo(rightPanel);
        $("<div class='wb dibuduiqi'></div>").html(
            "<span class='excel-rightmomuse-icon-css'><i class='fa fa-angle-double-down'></i></span><span class='excel-rightmomuse-text-css'>底部对齐</span>"
        ).appendTo(rightPanel);
        var setting = $("<div class='wb setting'></div>").html(
            "<span class='setting-item'><span class='setting-text'>宽</span><span class='setting-input'><input type='text' name='width' title='为空,按百分比'/></span></span><span class='setting-item'><span class='setting-text'>行</span><span class='setting-input'><input type='text' name='row'/></span></span><span class='setting-item'><span class='setting-text'>列</span><span class='setting-input'><input type='text' name='col'/></span></span>"
        ).appendTo(leftPanel);
        ...
        rightMousePanel.find(".wb").click(function () {
            ...
            if (!obj.hasClass("duiqifangsi") && !obj.hasClass("setting")) {
                ...
                if (obj.hasClass("shangchayihang") || obj.hasClass("xiachayihang") || obj.hasClass(
                    "zuochayilie") || obj.hasClass("youchayilie") || obj.hasClass("shanchuhang") || obj
                    .hasClass("shanchulie")) {
                    drugCell(table, t)
                }
